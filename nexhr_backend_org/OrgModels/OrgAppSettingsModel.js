...
const OrgApplicationSettingsSchemas = {};

function getApplicationSettingsSchema(orgName) {
    if (!OrgApplicationSettingsSchemas[orgName]) {
        ...
        OrgApplicationSettingsSchemas[orgName] = new mongoose.Schema({
    ...
    return OrgApplicationSettingsSchemas[orgName];
}

const OrgApplicationSettingsModels = {};

function getApplicationSettingsModel(orgName) {
    if (!OrgApplicationSettingsModels[orgName]) {
        OrgApplicationSettingsModels[orgName] = mongoose.model(
            `${orgName}_ApplicationSettings`,
            getApplicationSettingsSchema(orgName)
        );
    }
    return OrgApplicationSettingsModels[orgName];
}
...
module.exports = { getApplicationSettingsModel, applicationSettingsValidation }
