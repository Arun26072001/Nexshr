...
const Roles = () => {
    ...
    const [isViewAuth, setIsViewAuth] = useState(false);

    function manageAuthorization(id) {
        setIsViewAuth(!isViewAuth);
    }
    ...
    return (
        isLoading ? <Loading /> :
            isViewAuth ? <PageAndActionAuth manageAuthorization={manageAuthorization} /> :
                <div className='dashboard-parent pt-4'>
                    <div className="row">
                        ...
                        <div className='col-lg-6 col-6 d-flex gap-2 justify-content-end'>
                            {/* <Popup /> */}
                            {/* <div className='ms-2'> */}
                            <button className='button m-0' onClick={() => navigate}>+ Add Role</button>
                    ...
                    {
                        roles.length > 0 ?
                            <LeaveTable data={roles} manageAuthorization={manageAuthorization} />
