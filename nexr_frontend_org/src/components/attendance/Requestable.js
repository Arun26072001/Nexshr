    ...
    format: (value) => (
      <div className="editdropdown">
        ...
        <div className="editdropdown-menu">
          <Link to={"/edit"}>
            <span className="ms-2">Change log</span>
          </Link>
          <div className="commonActionPadding">
            <span className="ms-2">Approve</span>
          </div>
          <div className="commonActionPadding">
            <span className="ms-2 text-danger">Reject</span>
          </div>
        </div>
      </div>
    ),
...
function createData(profile, punch_in, total_hours, department, file, status, action) {
  return { profile, punch_in, total_hours, department, file, status,action };
}
