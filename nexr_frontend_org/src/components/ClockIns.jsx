...
const ClockIns = ({ handleLogout }) => {
    const { startTimer, stopTimer, workTimeTracker, updateWorkTracker } = useContext(TimerStates)
            ...
            <div className='good container-fluid row mx-auto'>
                ...
                <div className="col-lg-6 d-flex justify-content-end gap-2 align-items-center">
                    ...
                    <div className='leaveIndicator'>
                        <button class={`btn btn-outline-${isPaused ? "success" : "danger"}`} style={{ padding: "10px 15px" }} onClick={isPaused ? startTimer : stopTimer} id="startTimerBtn">
