...
const RadioButtons = ({ RadioOption, handleRadioOption, names, title, name }) => {
  return (
    <div className='col-lg-4 text-center my-2 d-flex align-content-center gap-4'>
      {title && <p>
        <b>{title}</b>
      </p>}
      ...
      <button name={name} className={`ms-1 outline-btn ${RadioOption === 0 && "enable"} border-0`} onClick={handleRadioOption}
        value={RadioOption}
