    ...
    return (
        <div className="webnxs">
            <div className="row mx-auto">
                ...
                <div className="col-lg-6 col-md-6 col-sm-6 col-6 d-flex align-items-center justify-content-end">
                    ...
                    <span className="bell ms-3"><svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
